...
function buscar_propi_cuenta() {
  var textoBusqueda = document.getElementById('bus_propi_cuenta').value.toLowerCase();
...
document.getElementById("bus_propi_cuenta").addEventListener("keyup", buscar_propi_cuenta);