...
function buscar_cunta_auto_tabla() {
  var textoBusqueda = document.getElementById('busca_concep_automa').value.toLowerCase();
  var tabla = document.getElementById('tabla_auto_individial');
  var filas = tabla.getElementsByTagName('tr');
  for (var i = 1; i < filas.length; i++) {
    var celdas = filas[i].getElementsByTagName('td');
    var coincidencia = false;
