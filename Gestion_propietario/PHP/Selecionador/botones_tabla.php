<rel='stylesheet' type='text/css' media='screen' href='CSS/seleccionador/botones_tabla.css'>

<div id="cuadro_pro" class="mod">

<div class="centro">

<div class="c1">

<button onclick="cerrar_cuadro_pro()" type="button">X</button>
