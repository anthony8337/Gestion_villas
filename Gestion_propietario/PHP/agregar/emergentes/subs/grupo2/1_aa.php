<link rel='stylesheet' type='text/css' media='screen' href='CSS/agregar/sub_emergente/mod_propietario_pago.css'>
<script src="JS/archivo/accion_sub.js"></script>

<div id="propietario_seleccionar_pago" class="mod">

<div class="centro">

<div class="c1">

<button onclick="selec_pro_pago_cerrar()" type="button">X</button>
<h2>Seleccionar propietario disponible</h2>
</div>

<div class="c2">
<input type="text" placeholder="Buscar propietario disponible" id="bus_propi_pago">
...
{
    echo"<table id='pago_propietario'>";
    echo"
    <tr>
    <th>ID</th>
    <th>Villa</th>
...
<script src="JS/buscar/subs/buscar_propi_pago.js"></script>
