...
-- Tiempo de generación: 26-01-2025 a las 17:37:51
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `ejecutar_cuentas` ()   BEGIN
...
(1, NULL, NULL, '0', '0', '2025-01-01', '2025-01-01', 'Pago', '1000000', NULL, 'completo');
...
(962, 23, 4, 3, 200, 18, 'no'),
(963, 23, 4, 2, 250, 18, 'no'),
(964, 23, 4, 1, 100, 18, 'no');
...
--
ALTER TABLE `propietarios`
  MODIFY `id_propietario` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `propietarios_villas`
--
ALTER TABLE `propietarios_villas`
  MODIFY `id_unir` int NOT NULL AUTO_INCREMENT;
...
-- Eventos
--
CREATE DEFINER=`root`@`localhost` EVENT `Rutina_cuentas` ON SCHEDULE EVERY 1 MONTH STARTS '2025-02-01 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO CALL ejecutar_cuentas()$$
